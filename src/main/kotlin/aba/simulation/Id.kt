...
class Id : IdList() {
    companion object {
        ...
        val agentEnviroment = 1
        val agentModel = 2
        val agentStation = 3
        val agentBusStop = 5
        val agentTransport = 6
        val agentBus = 8
        val managerEnviroment = 101
        val managerModel = 102
        val managerStation = 103
        ...
        val busWaitingCA = 1118
        val incomeWaitingBusCA = 1009
